...
class Mashina(models.Model):
    zavodsk_nomer = models.CharField(unique=True, max_length = 255)
    ...
    model_umost = models.ForeignKey(Model_umost, on_delete=models.CASCADE)
    ...
    servis_partn = models.ForeignKey('service.Servis', on_delete=models.CASCADE)
